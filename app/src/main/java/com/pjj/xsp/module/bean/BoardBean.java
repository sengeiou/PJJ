    ...
    public boolean isChange(BoardBean boardBean) {
        ...
        if (data == Data) {
            ...
            if (null != Data && null != data) {
                return !data.getUpDown().equals(Data.getUpDown()) ||
                        !data.getDoorState().equals(Data.getDoorState()) ||
                        !data.getFaultReportA().equals(Data.getFaultReportA()) ||
                        !data.getFaultReportB().equals(Data.getFaultReportB()) ||
                        !data.getFloor().equals(Data.getFloor());
            } else {
                return true;
            }
        }
