...
/**
 * Create by xinheng on 2018/11/03。
 * describe：
 */
public class SurfaceVideoView extends SurfaceView implements Callback {
    ...
    private String mUri;
    private LinearForSurface parent;
    ...
    protected void initVideoView() {
        ...
        getHolder().setFormat(PixelFormat.TRANSLUCENT); // PixelFormat.RGB_565
    ...
    public void setParent(LinearForSurface parent) {
        this.parent = parent;
    }
    ...
    public void openVideo(String uri) {
        if (uri == null || mSurfaceHolder == null || getContext() == null) {
            ...
            //Log.e(TAG, "openVideo: " + (mSurfaceHolder == null) + ", " + (getContext() == null));
        ...
        try {
            ...
            if (uri.contains("android.resource:")) {
                mMediaPlayer.setDataSource(getContext(), Uri.parse(mUri), null);
            } else {
    ...
    MediaPlayer.OnPreparedListener mPreparedListener = new MediaPlayer.OnPreparedListener() {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            Log.e(TAG, "onPrepared: " + width + ", " + height);

            //parent.setViedoSize(width, height);
            //requestLayout();
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Log.e(TAG, "surfaceCreated: holder=" + (holder == null));
        boolean needReOpen = (mSurfaceHolder == null);
        mSurfaceHolder = holder;
        if (needReOpen || mUri != null) {
            reOpen();
        }
    }
